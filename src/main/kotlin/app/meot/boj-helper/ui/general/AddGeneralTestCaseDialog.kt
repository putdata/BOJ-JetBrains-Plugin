...
class AddGeneralTestCaseDialog(
    project: Project?,
    private val defaultName: String = "",
    private val editingCase: GeneralTestCase? = null,
    ...
    init {
        title = if (editingCase != null) "테스트 케이스 편집" else "테스트 케이스 추가"
    ...
    fun getGeneralTestCase(): GeneralTestCase {
        return GeneralTestCase(
            input = inputArea.text,
            expectedOutput = expectedOutputArea.text,
        )
    }
}
